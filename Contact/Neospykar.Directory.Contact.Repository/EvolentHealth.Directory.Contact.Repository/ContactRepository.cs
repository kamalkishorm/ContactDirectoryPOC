...
using Neospykar.Directory.Core.Utils;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;

namespace Neospykar.Directory.Contact.Repository
{
    /// <summary>
    ...
    {
        private readonly NeospykarDirectoryContext _context;
        private readonly ILogger<ContactRepository> _logger;

        public ContactRepository(NeospykarDirectoryContext context, ILogger<ContactRepository> logger)
        {
            _context = context;
            _logger = logger;
        }
