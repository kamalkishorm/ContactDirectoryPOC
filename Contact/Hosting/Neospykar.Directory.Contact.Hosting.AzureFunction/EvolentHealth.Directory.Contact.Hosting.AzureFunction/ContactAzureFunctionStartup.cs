using Neospykar.Directory.Contact.Contract;
using Neospykar.Directory.Contact.Contract.Configurations;
using Neospykar.Directory.Contact.Hosting.AzureFunction;
using Neospykar.Directory.Core.AspNet;
using Microsoft.Azure.Functions.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Options;
using Neospykar.Directory.Contact.Hosting.Bootstrap.Configuration.DependencyInjection;
using Microsoft.Extensions.Hosting;

[assembly: FunctionsStartup(typeof(ContactAzureFunctionsStartup))]

namespace Neospykar.Directory.Contact.Hosting.AzureFunction
{
