using Neospykar.Directory.Contact.Business;
using Neospykar.Directory.Contact.Contract.Configurations;
using Neospykar.Directory.Contact.Contract.Interface.Business;
using Neospykar.Directory.Contact.Contract.Interface.DataAccess;
using Neospykar.Directory.Contact.Contract.Interface.Repository;
using Neospykar.Directory.Contact.DataAccess;
using Neospykar.Directory.Contact.Repository;
using Neospykar.Directory.Contact.Repository.Context;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;

namespace Neospykar.Directory.Contact.Hosting.Bootstrap.Configuration.DependencyInjection
{
    public static class ContactServiceCollectionExtensions
    {
        ...
        private static void AddContactDatabase(IServiceCollection services, ContactConfiguration contactConfiguration,
            bool isDevelopment)
        {
            services.AddDbContext<NeospykarDirectoryContext>(options =>
            {
